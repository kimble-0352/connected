    ...
    difficulties.forEach(difficulty => {
      ...
      for (let i = 1; i <= 100; i++) {
        ...
        const gradeMapping: { [key: string]: { schoolLevel: '초등' | '중등' | '고등', grade: string, semester: string } } = {
          '1-1': { schoolLevel: '중등', grade: '중1', semester: '1학기' },
          '1-2': { schoolLevel: '중등', grade: '중1', semester: '2학기' },
          '2-1': { schoolLevel: '중등', grade: '중2', semester: '1학기' },
          '2-2': { schoolLevel: '중등', grade: '중2', semester: '2학기' },
          '3-1': { schoolLevel: '중등', grade: '중3', semester: '1학기' },
          '3-2': { schoolLevel: '중등', grade: '중3', semester: '2학기' }
        };
        
        const gradeInfo = gradeMapping[grade] || { schoolLevel: '중등', grade: '중2', semester: '1학기' };
